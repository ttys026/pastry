...
declare function dayjs(date?: import('dayjs').dayjs.ConfigType): import('dayjs').dayjs.Dayjs;

declare function dayjs(
  date?: import('dayjs').dayjs.ConfigType,
  format?: import('dayjs').dayjs.OptionType,
  strict?: boolean
